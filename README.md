...
This site runs using static HTML/CSS/JavaScript and should not require any further server interactions beyond serving the static page. No backend database should be necessary for the function of this webpage, etc. No private information is stored on this site.
